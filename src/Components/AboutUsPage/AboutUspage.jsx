        ...
        <div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <div className="p-4 my-4 space-y-3 border-x shadow-lg border-1 border-black dark:border-black rounded-xl">
                    ...
                    <div className="p-4 space-y-3 border-x shadow-lg border-1 border-black dark:border-black rounded-xl">
                        <span className="inline-block text-black dark:text-black">
