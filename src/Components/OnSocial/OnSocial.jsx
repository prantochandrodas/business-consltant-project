    ...
    return (
        <div>
            <div className="w-[90%] mx-auto">
                <h1 className="uppercase text-2xl font-semibold text-center my-10">Fingertips ON SOCIAL</h1>
                <Slider {...settings}>
                    <div className="lg:!w-[300px] !w-[300px] mb-5 ml-[20px] mx-auto mt-4 shadow-lg border rounded-2xl duration-300 hover:shadow-sm">
                        <img src="https://www.encoders.co.in/images/facebook/post2.jpg" loading="lazy" alt="" className="w-full h-48 rounded-t-md" />

                        <div className="pt-3 ml-4 mr-2 mb-3">
                            <h3 className="text-lg text-gray-900 py-5 text-center">
                                Happy Holi
                            </h3>
                        </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 bg-white my-10 py-10 px-5 w-[90%] mx-auto">
                <img className="lg:w-[200px]" src="https://www.encoders.co.in/images/certificateion/encoISO.png" alt="" />
                <img className="lg:w-[200px]" src="https://www.encoders.co.in/images/certificateion/isocertified.jpg" alt="" />
                <img className="lg:w-[200px]" src="https://www.encoders.co.in/images/certificateion/3000customer.jpg" alt="" />
                <img className="lg:w-[200px]" src="https://www.encoders.co.in/images/certificateion/exp12yrs.jpg" alt="" />
            </div>
        </div>
    );
};
