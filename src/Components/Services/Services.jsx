        ...
        <div className='bg-[#efefef] lg:my-20'>
            <div className='w-[90%] mx-auto lg:grid md:grid md:grid-cols-2 grid-cols-3 gap-x-10 py-20'>
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red] '>
                    ...
                    <p className='text-justify'><strong>Mobile App Development Services</strong>We provide wide range of enterprise  including mobile UI design, smartphone solutions, custom application and many more.</p>
                </div>
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red]'>
                    <div className='lg:flex block items-center'>
                    ...
                    <p className='text-justify'>We provide a robust &amp; scalable <strong>Ecommerce Development Service</strong> which adapts with your business processes &amp; culture. We offer you all of the necessary design, development and search engine marketing services needed to be successful online portal business.</p>
                </div>
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red]'>
                    <div className='lg:flex block items-center'>
                ...
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red]'>
                    ...
                    <p className='text-justify'>We provide wide range of software applications development services including HRM, CRM, Billing Module, Logistics Module, Invoice systems and Custom Application and many more.</p>
                </div>
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red]'>
                    <div className='lg:flex block items-center'>
                    ...
                    <p className='text-justify'>Apart from web designing and the web development services, we also need to take a closer look at search engine optimization and marketing to take the full advantage of the latest consumer trends.</p>
                </div>
                <div className='my-10 bg-white p-4 rounded-lg border-x border-[red]'>
                    <div className='lg:flex block items-center'>
